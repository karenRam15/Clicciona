  ...
  <header id="header" class="fixed-top header-inner-pages">
    <div class="container d-flex align-items-center">
     ...
     <h1 class="logo mr-auto"><a href="index.php">Clicciona</a></h1>
      ...
      <a href="#about" class="get-started-btn scrollto">Acceso</a>
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <div class="member d-flex align-items-start" data-aos="zoom-in" data-aos-delay="100">
              <div class="pic"><img src="assets/img/team/ipn.jpg" class="img-fluid" alt=""></div>
              <div class="member-info">
                <h4>IPN</h4>
                <span> Instituto Politécnico Nacional</span>
                <h4>Ubicación</h4>
                <p>Dirección postal. Facultad de Ciencias, IPN Av. Universidad 3000, Circuito Exterior S/N Delegación Coyoacán, C.P. 04510. Ciudad Universitaria, D.F.</p>
                 <h4>Becas</h4>
                 <p>Apoyar con becas de exención total o parcial a las y los estudiantes.</p>
                 <h4>Promoticket</h4>
                <div class="pic"><img src="assets/img/QR.png" class="img-fluid" alt=""></div>
                <h4>Telefono</h4>
                <p>+525556225565</p>
                <h4>Encuentranos</h4>
                <div class="social">
          ...
          <div class="col-lg-6 mt-4 mt-lg-0">
            <div class="member d-flex align-items-start" data-aos="zoom-in" data-aos-delay="200">
              <div class="pic"><img src="assets/img/team/unam.jpg" class="img-fluid" alt=""></div>
              <div class="member-info">
                <h4>UNAM</h4>
                <span>Universidad Nacional Autónoma de México</span>
                 <h4>Ubicación</h4>
                <p>Dirección postal. Facultad de Ciencias, UNAM Av. Universidad 3000, Circuito Exterior S/N Delegación Coyoacán, C.P. 04510. Ciudad Universitaria, D.F.</p>
                 <h4>Becas</h4>
                 <p>Apoyar con becas de exención total o parcial a las y los estudiantes.</p>
                 <h4>Promoticket</h4>
                <div class="pic"><img src="assets/img/QR.png" class="img-fluid" alt=""></div>
